...
const heroData = {
  description: [
    "Learn networking, Linux, cryptography & security fundamentals.",
    "Master Web, Network & API Penetration Testing with real labs.",
    "Work with SOC tools like SIEM, Threat Hunting & Incident Response.",
    "Learn Cloud Security, Red Teaming & modern cyber defense techniques.",
  ],
